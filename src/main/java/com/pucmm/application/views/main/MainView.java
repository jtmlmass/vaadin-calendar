package com.pucmm.application.views.main;
...
import com.pucmm.application.views.gerentes.GerentesView;
import com.pucmm.application.views.configuracióngerencial.ConfiguraciónGerencialView;
import com.pucmm.application.views.calendario.CalendarioView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "Vaadin Calendar", shortName = "Vaadin Calendar")
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logos/18.png", "Vaadin Calendar logo"));
        logoLayout.add(new H1("Vaadin Calendar"));
    ...
    private Component[] createMenuItems() {
        RouterLink[] links = new RouterLink[] {
            new RouterLink("Gerentes", GerentesView.class),
            new RouterLink("Configuración Gerencial", ConfiguraciónGerencialView.class),
