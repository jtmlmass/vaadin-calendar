package com.pucmm.application.views.configuracióngerencial;
...
@Route(value = "config-gerente", layout = MainView.class)
@PageTitle("Configuración Gerencial")
@CssImport("styles/views/configuracióngerencial/configuración-gerencial-view.css")
public class ConfiguraciónGerencialView extends Div {
    ...
    public ConfiguraciónGerencialView() {
        setId("configuración-gerencial-view");
